  ...
  timeLineItem :{
    ...
    [theme.breakpoints.up('md')]: {
     ...
     '&:nth-of-type(2n):before': {
         right: 'auto',
         left: '-0.625rem',
         boderColor: 'transparent transparent tomato tomato'
     }
...
const Resume = () => {
    ...
    return (
        ...
        <Box component='div' className={classes.timeLine} >
           ...
           <Box container= 'div' className={classes.timeLineItem}>
               ...
               <Typography variant='subtitle1' aligh='center' style={{color: 'tan'}}>
                   description of the text about your worke in th company over here.
               </Typography>
           </Box>
           <Typography variant='h2' 
           className={`${classes.timeLineYear} ${classes.timeLineItem}`}
